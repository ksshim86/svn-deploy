...
public class ProjectController {
    ...
    @PostMapping
    public ResponseEntity<ProjectSaveResponse> saveProject(@RequestBody ProjectSaveRequest projectSaveRequest) throws Exception {
        ProjectSaveResponse projectSaveResponse = projectService.saveProject(projectSaveRequest);

        return new ResponseEntity<>(projectSaveResponse, HttpStatus.CREATED);
    }
